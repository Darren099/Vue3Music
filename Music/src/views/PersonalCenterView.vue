...
.aui-chang-box{
    ...
    background: -webkit-linear-gradient(#97fac4, #88efab);
    background: -o-linear-gradient(#97fac4, #88efab);
    background: -moz-linear-gradient(#97fac4, #88efab);
    background: linear-gradient(#97fac4, #88efab);
    height:2.5rem;
}
