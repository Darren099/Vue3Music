    ...
    <div class="login-contain">
        ...
        <div class="order-login">
            ...
            <div class="order-login-box">
                <div>
                    <a href="javascript:;">
                        <img src="@/assets/images/wechat-login.png" alt="" style="width: 45px;height: 45px;">
                        <p>微信登录</p>
                    </a>
                </div>
            </div>
...
export default {
  ...
  methods: {
    loginEvent: async function () {
      const res = await this.$store.dispatch('login', { phone: this.phone, password: this.password })
